...
public:
    ...
    void Update(float deltaTime, float time, Vector3 playerPosition, Vector3 playerForward, bool boatLightOn);
...
private:
    ...
    int waterLightDirLoc, waterLightCutoffLoc;
    int worldLightDirLoc, worldLightCutoffLoc;
